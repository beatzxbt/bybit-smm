...
from frameworks.exchange.dydx.types import DydxSideConverter
    ...
    def refresh(self, recv: List[Dict]) -> None:
        try:
            for trade in recv["result"]["list"]:
                ...
                self.format[1] = DydxSideConverter.to_num(trade["side"])
    ...
    def process(self, recv: Dict) -> None:
        try:
            for trade in recv["data"]:
                ...
                self.format[1] = DydxSideConverter.to_num(trade["S"])

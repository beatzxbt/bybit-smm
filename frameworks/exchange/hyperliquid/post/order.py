...
from frameworks.exchange.hyperliquid.post.client import HyperLiquidPrivatePostClient
from frameworks.exchange.hyperliquid.endpoints import PrivatePostLinks
from frameworks.exchange.hyperliquid.post.types import OrderTypesFutures
...
class HyperLiquidOrder:
    ...
    def __init__(self, sharedstate: PrivateDataSharedState, symbol: str) -> None:
        ...
        self.client = HyperLiquidPrivatePostClient(self.pdss)
